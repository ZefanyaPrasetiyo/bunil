/*
  ...
  - The values [PSPT] on the enum `Jurusan` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Jurusan_new" AS ENUM ('DKV', 'RPL', 'ANIMASI', 'TKJ', 'BC', 'TE');
